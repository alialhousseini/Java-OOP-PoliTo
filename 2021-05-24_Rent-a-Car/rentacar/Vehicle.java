...
public class Vehicle {
	...
	public String print_id() {
		return String.format("  %d %c:%s:%s",this.getId(), this.getCategory(), this.getManufacturer(), this.getModel());
	}
	
	public String print_id2() {
		return String.format("%s:%s:%s",this.getManufacturer(), this.getModel(), this.getColor());
	}
